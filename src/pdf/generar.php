...
$pdf->Cell(27, 5, utf8_decode('Descripción'), 0, 0, 'L');
$pdf->Cell(8, 5, 'Cant', 0, 0, 'C');
$pdf->Cell(15, 5, 'Vl.Unit', 0, 0, 'C');
$pdf->Cell(20, 5, 'Sub Total.', 0, 1, 'C');
$pdf->SetFont('Arial', '', 7);
$contador = 1;
$x = $pdf->GetX();
$y = $pdf->GetY();
...
while ($row = mysqli_fetch_assoc($ventas)) {
    ...
    /*$pdf->Cell(27, 5, 'este es un produto  de nombre',0, 0, 'L');
    $pdf->Cell(8, 5, $row['cantidad'], 0, 0, 'R');
    $pdf->Cell(15, 5, number_format($row['precio'], 0, '.', ','), 0, 0, 'R');
    $pdf->Cell(20, 5, number_format($row['cantidad'] * $row['precio'], 0, '.', ','), 0, 1, 'R');*/
